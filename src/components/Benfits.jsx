...
const Benfits = () => {
  return (
    <div id="benefits" className="bg-white py-6 sm:py-8 lg:py-12">
      <div className="mx-5 max-w-screen-2xl px-4 md:px-8 md:mt-16 md:mb-12">
        {/* Text - start */}
        <div className="mb-10 md:mb-16">
          ...
          <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">
            Why would someone want to use our website?
          </p>
        </div>
        {/* Text - end */}
        ...
        <div className="grid gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16">
          ...
          <div className="flex gap-4 md:gap-6">
            ...
            <div>
              <h3 className="mb-2 text-lg font-semibold md:text-xl">Get actionable insights quickly</h3>
              <p className="mb-2 text-gray-500">
                Instantly visualize key trends and patterns to make informed decisions faster.
              </p>
              <a
                href="#"
                className="font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700"
          ...
          <div className="flex gap-4 md:gap-6">
            ...
            <div>
              <h3 className="mb-2 text-lg font-semibold md:text-xl">Data Driven Decisions</h3>
              <p className="mb-2 text-gray-500">
                Empower your business with accurate predictions to guide future strategies and growth.
              </p>
              <a
                href="#"
                className="font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700"
